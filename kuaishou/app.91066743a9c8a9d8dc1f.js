(() => {
        ...
        var __webpack_modules__ = {
            ...
            14735: (e, t, r) => {
                ...
                function E() {
                    return (E = (0, o.A)(i().mark((function e(t) {
                            return i().wrap((function (e) {
                                    for (; ;)
                                        switch (e.prev = e.next) {
                                            case 0:
                                                return e.abrupt("return", new Promise((function (resolve, reject) {
                                                        f.I.call("$encode", [t, {
                                                            suc: function (t, r) {
                                                                resolve({
                                                                    signResult: t,
                ...
                function handle_combine_websocket_url(e, t) {
                    return combine_websocket_url.apply(this, arguments)
                }

                function combine_websocket_url() {
                    return combine_websocket_url = (0,
                        o.A)(i().mark((function e(t, r) {
                            var n, caver, _, a, hxfalcon_val, u, c = arguments;
                            return i().wrap((function (e) {
                                    for (; ;)
                                        switch (e.prev = e.next) {
                                            case 0:
                                                return n = c.length > 2 && void 0 !== c[2] ? c[2] : {},
                                                    e.prev = 1,
                                                    // console.info(f.I),
                                                    caver = f.I.call("$getCatVersion") || "",   // window.Jose.call("$getCatVersion")
                                                    _ = {
                                                        url: r,
                                                        query: y({
                                                            caver: caver
                                            ...
                                            case 6:
                                                return a = e.sent,
                                                    hxfalcon_val = a.signResult,
                                                    u = t.includes("?") ? "&" : "?",
                                                    e.abrupt("return", "".concat(t).concat(u, "__NS_hxfalcon=").concat(hxfalcon_val, "&caver=").concat(caver));
                                            case 12:
                                                return e.prev = 12,
                                                    e.t0 = e.catch(1),
                                                    (0,
                        ...
                        combine_websocket_url.apply(this, arguments)
                }
                                    ...
                                    for (; ;)
                                        switch (e.prev = e.next) {
                                            case 0:
                                                ...
                                                return e.next = 4,
                                                    handle_combine_websocket_url(t.url, r.realUrl, t.params);
                                            case 4:
                                                t.url = e.sent;
                                            case 5:
                ...
                _.cipher.aes = function (e) {
                    ...
                    _.cipher.aes.prototype = {
                        ...
                        _crypt: function (e, t) {
                            ...
                            var r, n, o, i, a = this._key[t], s = e[0] ^ a[0], u = e[t ? 3 : 1] ^ a[1], c = e[2] ^ a[2], l = e[t ? 1 : 3] ^ a[3],
                                p = a.length / 4 - 2, f = 4, d = [0, 0, 0, 0], y = this._tables[t], h = y[0], E = y[1], m = y[2], b = y[3], v = y[4];
                            for (i = 0; i < p; i++)
            ...
            16265: (e, t, r) => {
                                ...
                                return c().wrap((function (e) {
                                        for (; ;)
                                            switch (e.prev = e.next) {
                                                case 0:
                                                    var mmm = (0, p.qD)(t);
                                                    console.info('send=>', t, mmm);
                                                    null === (r = a.value) || void 0 === r || r.send(mmm);
                                                case 1:
                                                case "end":
                                                    return e.stop()
                                            }
                ...
                function O(e, t) {
                    ...
                    if (!m.S$) {
                        var n, o = r.target, _ = void 0 === o ? window : o, i = r.passive, a = void 0 !== i && i, s = r.capture,
                            u = void 0 !== s && s, c = function (r) {
                                var o = (0,
                                    l.R1)(r);
                    ...
                    , Jose = function (e) {
                        ...
                        , function (e, t, r) {
                            (function (t) {
                                    ...
                                    (function () {
                                            var o, _ = {}.hasOwnProperty, i = (o = r(0)).prototypeOf, a = o.hasProp, s = (o = r(2)).ArrayIterator,
                                                u = o.StopIteration;
                        ...
                        , function (module, exports, __nested_webpack_require_25660__) {
                            ...
                            (function () {
                                    var ref = __nested_webpack_require_25660__(2), StopIteration = ref.StopIteration,
                                        ref1 = __nested_webpack_require_25660__(0), defProp = ref1.defProp, hasProp = ref1.hasProp,
                                        ref3 = __nested_webpack_require_25660__(3), Fiber = ref3.Fiber, Scope = ref3.Scope, WithScope = ref3.WithScope,
                                        OpcodeClassFactory = (o = 0,
                                                function (e, t, r) {
                                                    var n;
                                                    return (n = function (e) {
                                                            e && (this.args = e)
                    ...
                    if (t.payload) {
                        var r, n, o = (r = t.compressionType,
                            ...
                            3 === r && n ? function (e) {
                                ...
                                var t
                            }(n) : 2 === r && n ? (0, a.UD)(n) : n), _ = t.payloadType, i = mmmsg_type[_];
                        if (i)
                            return m(i, o)
                    }
                }
        ...
        __webpack_require__.m = __webpack_modules__,
            ...
            /**
             * deferred 是一个数组，用于存储待执行的回调函数及其依赖条件。
             * 每个元素是一个三元组 [dependencies, callback, priority]：
             * dependencies：一个数组，包含该回调依赖的模块 ID
             * callback：依赖满足时执行的函数
             * priority：执行优先级（数字越小越优先）
             */
            deferred = [],
            /**
             * 异步模块加载时，使用 __webpack_require__.O 注册回调及其依赖
             * 当一个模块加载完成时，调用 __webpack_require__.O 检查是否有可执行的回调
             * 检查每个回调的依赖是否满足，满足则执行
             * 执行结果传递给下一个回调或返回给调用者
             */
            /**
             * e：当前执行结果（或初始值）
             * t：依赖的模块 ID 数组（如果为 undefined 则表示检查并执行所有可执行的回调）
             * r：依赖满足时执行的回调函数
             * n：执行优先级（数字越小越优先，默认为 0）
             */
            __webpack_require__.O = (init_val, num_array, cb_fun, priority) => {
                if (!num_array) {
                    var o = 1 / 0;  // Infinity
                    for (s = 0; s < deferred.length; s++) {
                        for (var [dependencies, deferred_cb, deferred_priority] = deferred[s], _ = !0, i = 0; i < dependencies.length; i++)
                            (!1 & deferred_priority || o >= deferred_priority) && Object.keys(__webpack_require__.O).every((e => __webpack_require__.O[e](dependencies[i]))) ? dependencies.splice(i--, 1) : (_ = !1,
                            deferred_priority < o && (o = deferred_priority));
                        if (_) {
                            deferred.splice(s--, 1);
                            var a = deferred_cb();
                            void 0 !== a && (init_val = a)
                ...
                priority = priority || 0;
                for (var s = deferred.length; s > 0 && deferred[s - 1][2] > priority; s--)
                    deferred[s] = deferred[s - 1];
                deferred[s] = [num_array, cb_fun, priority]
            }
            ,
            ...
            ,
            __webpack_require__.d = (e, t) => { //给e设置t的属性
                for (var r in t)
            ...
            __webpack_require__.e = js_part_num => {    //vue组件依赖加载调用这个
                // console.info('__webpack_require__.e => ',js_part_num);
                return Promise.all(Object.keys(__webpack_require__.f).reduce(((ljq, current_val) => (__webpack_require__.f[current_val](js_part_num, ljq), ljq)), []))
            },//遍历数组累加执行，等加载完毕返回Promise
            ...
            __webpack_require__.h = () => "91066743a9c8a9d8dc1f",
            ...
            __webpack_require__.l = (js_url, t, js_name, js_num) => {   //加载js
                if (inProgress[js_url])
                    inProgress[js_url].push(t);
                else {
                    var o, _;
                    if (void 0 !== js_name)
                        for (var script_array = document.getElementsByTagName("script"), a = 0; a < script_array.length; a++) {
                            var script_item = script_array[a];
                            if (script_item.getAttribute("src") == js_url || script_item.getAttribute("data-webpack") == dataWebpackPrefix + js_name) {
                                o = script_item;
                                break
                            }
                        }
                    ...
                    __webpack_require__.nc && o.setAttribute("nonce", __webpack_require__.nc),
                        o.setAttribute("data-webpack", dataWebpackPrefix + js_name),
                        o.src = js_url),
                        inProgress[js_url] = [t];
                    var timeout_fun = (t, r) => {
                        o.onerror = o.onload = null,
                            clearTimeout(c);
                        var t_fun = inProgress[js_url];
                        if (delete inProgress[js_url],
                        o.parentNode && o.parentNode.removeChild(o),
                        t_fun && t_fun.forEach((e => e(r))),
                            t)
                            return t(r)
                    }
                        , c = setTimeout(timeout_fun.bind(null, void 0, {
                        type: "timeout",
                        target: o
                    }), 12e4);
                    o.onerror = timeout_fun.bind(null, o.onerror),
                        o.onload = timeout_fun.bind(null, o.onload),
            ...
            (() => {
                    ...
                    __webpack_require__.f.j = (js_num, r) => {
                        var n = __webpack_require__.o(e, js_num) ? e[js_num] : void 0;
                        if (0 !== n)
                            if (n)
                                r.push(n[2]);
                            else {
                                // var o = new Promise(((resolve, reject) => n = e[js_num] = [()=>{debugger;return resolve;}, reject]));
                                var o = new Promise(((resolve, reject) => n = e[js_num] = [resolve, reject]));
                                r.push(n[2] = o);
                                var js_url = __webpack_require__.p + __webpack_require__.u(js_num)  //cdnpath + jsname.hash.js
                                    , _err = new Error;
                                __webpack_require__.l(js_url, (r => {
                                        if (__webpack_require__.o(e, js_num) && (0 !== (n = e[js_num]) && (e[js_num] = void 0), n)) {
                                            var o = r && ("load" === r.type ? "missing" : r.type)
                                                , js_src = r && r.target && r.target.src;
                                            _err.message = "Loading chunk " + js_num + " failed.\n(" + o + ": " + js_src + ")",
                                                _err.name = "ChunkLoadError",
                                                _err.type = o,
                                                _err.request = js_src,
                                                n[1](_err)
                                        }
                                    }
                                ), "chunk-" + js_num, js_num) //js_url, t, js_name, js_num
                            }
                    }
                        ,
                        __webpack_require__.O.j = t => 0 === e[t];  //e的某个部分是否是0
                    var t = (num_or_fun, one_live_next) => {
                        var live_next_fun_num, part_num_item, [part_num_array, live_next_fun, third_param] = one_live_next, s = 0;
                        if (part_num_array.some((t => 0 !== e[t]))) {
                            for (live_next_fun_num in live_next_fun)
                                __webpack_require__.o(live_next_fun, live_next_fun_num) && (__webpack_require__.m[live_next_fun_num] = live_next_fun[live_next_fun_num]);
                            if (third_param)
                                var u = third_param(__webpack_require__)
                        }
                        for (num_or_fun && num_or_fun(one_live_next); s < part_num_array.length; s++)
                            part_num_item = part_num_array[s],
                            __webpack_require__.o(e, part_num_item) && e[part_num_item] && e[part_num_item][0](),
                                e[part_num_item] = 0;
                        return __webpack_require__.O(u)
                    }
                        , __webpackChunkpc_live_next = self.webpackChunkpc_live_next = self.webpackChunkpc_live_next || [];
                    /**
                     * t.bind(null, 0) 等价于：
                     * const boundT = (secondParam) => {
                     *   t(0, secondParam); // 第一个参数永远是 0，第二个参数由调用时提供
                     * };
                     */
                    __webpackChunkpc_live_next.forEach(t.bind(null, 0)),    //参数 0 给 t方法的第一个参数，遍历array的当前值给t方法的第二个参数
                        __webpackChunkpc_live_next.push = t.bind(null, __webpackChunkpc_live_next.push.bind(__webpackChunkpc_live_next))
                }
            )(),
        ...
        window.__webpack_exports__ = __webpack_exports__;
